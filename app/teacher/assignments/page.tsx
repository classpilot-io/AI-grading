...
export default function AssignmentsPage() {
  ...
  const handleEditAssignment = (assignmentData: any) => {
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center space-x-2 mb-2">
                    <Badge 
                      variant={assignment.subject === 'Mathematics' ? 'default' : 'secondary'}
                      className={assignment.subject === 'Mathematics' 
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between text-sm">
                  <div className="flex items-center space-x-1 text-gray-500">
                    ...
                    <span className={getProgressColor(assignment.submissionCount, assignment.totalStudents)}>
